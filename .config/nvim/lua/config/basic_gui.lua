...
function M.setup()
    ...
    vim.opt.listchars = {
        lead = ' ',
        trail = '-', -- Optional: show dots for trailing spaces
        extends = '→', -- Optional: show arrow when line continues right
        precedes = '←', -- Optional: show arrow when line continues left
        tab = ' ',
    }
    vim.api.nvim_set_hl(0, 'CustomListChars', { fg = '#808080' }) -- Subtle
